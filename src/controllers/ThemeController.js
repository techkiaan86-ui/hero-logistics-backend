...
// Get all Themes with pagination, sorting and filtering
...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.theme.findFirst({ where });
...
// Update Theme with Optimistic Concurrency check
...
exports.delete = async (req, res, next) => {
  try {
    ...
    await prisma.theme.delete({ where });
