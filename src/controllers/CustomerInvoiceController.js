...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.customerInvoice.findFirst({ where });
...
// Update CustomerInvoice with Optimistic Concurrency check
...
exports.delete = async (req, res, next) => {
  try {
    ...
    await prisma.customerInvoice.delete({ where });
