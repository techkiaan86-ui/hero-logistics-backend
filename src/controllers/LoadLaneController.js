...
// Get all LoadLanes with pagination, sorting and filtering
...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.loadLane.findFirst({ where });
    
    if (!data) {
      return sendError(res, {
        code: ERROR_CODES.NOT_FOUND,
        message: 'LoadLane not found'
...
// Update LoadLane with Optimistic Concurrency check
...
exports.delete = async (req, res, next) => {
  try {
    ...
    await prisma.loadLane.delete({ where });
