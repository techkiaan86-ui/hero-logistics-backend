...
// Get all PaymentAttempts with pagination, sorting and filtering
...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.paymentAttempt.findFirst({ where });
    
    if (!data) {
      return sendError(res, {
        code: ERROR_CODES.NOT_FOUND,
        message: 'PaymentAttempt not found'
...
// Update PaymentAttempt with Optimistic Concurrency check
...
exports.delete = async (req, res, next) => {
  try {
    ...
    await prisma.paymentAttempt.delete({ where });
