...
// Get all SubscriptionPlans with pagination, sorting and filtering
...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.subscriptionPlan.findFirst({ where });
...
// Update SubscriptionPlan with Optimistic Concurrency check
