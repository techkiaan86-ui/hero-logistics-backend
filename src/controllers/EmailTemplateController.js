...
// Get all EmailTemplates with pagination, sorting and filtering
...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.emailTemplate.findFirst({ where });
...
// Update EmailTemplate with Optimistic Concurrency check
