...
// Get all UserSessions with pagination, sorting and filtering
...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.userSession.findFirst({ where });
...
// Update UserSession with Optimistic Concurrency check
