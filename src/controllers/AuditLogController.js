...
// Get all AuditLogs with pagination, sorting and filtering
...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.auditLog.findFirst({ where });
...
// Update AuditLog with Optimistic Concurrency check
...
exports.delete = async (req, res, next) => {
  try {
    ...
    await prisma.auditLog.delete({ where });
