...
// Get all PromoCodes with pagination, sorting and filtering
...
exports.getById = async (req, res, next) => {
  try {
    ...
    const data = await prisma.promoCode.findFirst({ where });
...
// Update PromoCode with Optimistic Concurrency check
